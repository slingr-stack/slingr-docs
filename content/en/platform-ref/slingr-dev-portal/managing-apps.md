...
![Create new app from Home]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/home_create_new_app.png)

👉 You can also create new apps from the **`Apps`** section by clicking the **`+ Create Apps`** button

![Create new app from Apps]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/apps_create_new_app.png)
...
- **`Template`**: You can choose to start from scratch, with an empty app, or you can choose one of the available templates. Here you will find global templates created by other people, or you can also create your own templates. See [App templates](#app-templates) for more information.
  ...
  ![Choose template]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/create_app_templates.png)
...
![App logos]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_details_logos.png)
...
![App environment details]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_environment_details_1.png)
...
![App environment details]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_environment_details_2.png)
...
![App developers]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_settings_developers.png)
![App developers]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_settings_add_developer.png)
...
![App admins]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_settings_admins.png)
![App admins]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_settings_add_admin.png)
...
![Sleep app]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/sleep_app.png)
![Wake up app]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/wakeup_app.png)
...
![Add prod environment]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_add_production_env.png)
...
![Add staging environment]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_add_staging_env.png)
...
![Unlink app]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/unlink_app.png)
...
![Add development environment]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/add_development_env.png)
...
![Delete App]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/delete_app.png)
...
![Make App a Template]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/app_make_a_template.png)
...
![Clone App]({{site.baseurl}}/images/vendor/platform-ref/managing-apps/clone_app.png)
