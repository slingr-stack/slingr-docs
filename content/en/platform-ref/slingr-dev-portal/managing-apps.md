...
![Create new app from Home](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/home_create_new_app.png)

👉 You can also create new apps from the **`Apps`** section by clicking the **`+ Create Apps`** button

![Create new app from Apps](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/apps_create_new_app.png)
...
- **`Template`**: You can choose to start from scratch, with an empty app, or you can choose one of the available templates. Here you will find global templates created by other people, or you can also create your own templates. See [App templates](#app-templates) for more information.
  ...
  ![Choose template](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/create_app_templates.png)
...
![App logos](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_details_logos.png)
...
![App environment details](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_environment_details_1.png)
...
![App environment details](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_environment_details_2.png)
...
![App developers](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_settings_developers.png)
![App developers](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_settings_add_developer.png)
...
![App admins](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_settings_admins.png)
![App admins](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_settings_add_admin.png)
...
![Sleep app](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/sleep_app.png)
![Wake up app](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/wakeup_app.png)
...
![Add prod environment](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_add_production_env.png)
...
![Add staging environment](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_add_staging_env.png)
...
![Unlink app](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/unlink_app.png)
...
![Add development environment](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/add_development_env.png)
...
![Delete App](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/delete_app.png)
...
![Make App a Template](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/app_make_a_template.png)
...
![Clone App](https://pmslingr.github.io/slingrDoc/images/vendor/platform-ref/managing-apps/clone_app.png)
