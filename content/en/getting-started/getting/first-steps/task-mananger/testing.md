...
![Actions Column](https://pmorales.github.io/slingrDoc/images/vendor/task-mananger/testing-actions/t.png)

### From "All tasks" view main menu

![All tasks main menu actions](https://pmorales.github.io/slingrDoc/images/vendor/task-mananger/testing-actions/tt.png)

### From task record view main menu

![Task record main menu actions](https://pmorales.github.io/slingrDoc/images/vendor/task-mananger/testing-actions/ttt.png)
