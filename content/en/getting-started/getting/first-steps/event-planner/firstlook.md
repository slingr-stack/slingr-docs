...
![Alt Text](https://pmorales.github.io/slingrDoc/images/vendor/event-planner/firstlook/ww_event_planner_readonly_no_delete.png)

--- 

👉 Click on the `Edit` button and change the status of the event to `Cancel`.

![Alt Text](https://pmorales.github.io/slingrDoc/images/vendor/event-planner/firstlook/ww_event_planner_status_field.png)
