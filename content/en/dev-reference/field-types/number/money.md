...
- **`Symbol`**: This represents the currency symbol that will be displayed in read-only mode.
...
{{< query_sample
        id="sample"
        description="finds skills with an average salary greater or equals to 80000.00"
        entity="skills"
        jsQueryMap="{'averageSalary': 'greaterOrEquals(80000.00)'}"
        jsQueryBuilder=".field('averageSalary').greaterOrEquals(80000.00)"
        restApi="averageSalary=greaterOrEquals(80000.00)"
>}}
<br>
